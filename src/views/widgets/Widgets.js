...
const Widgets = () => {
  // Generador determinístico para evitar funciones impuras durante el render
  const pseudo = (i, min, max) => {
                      ...
                      datasets: [
                        {
                          ...
                          borderWidth: 1,
                          data: Array.from({ length: 15 }, (_, i) => pseudo(i, 40, 100)),
                        },
                      ],
                    }}
                    options={{
                      ...
                      datasets: [
                        {
                          ...
                          borderColor: 'transparent',
                          borderWidth: 1,
                          data: Array.from({ length: 15 }, (_, i) => pseudo(i + 15, 40, 100)),
                        },
                      ],
                    }}
                    options={{
                      ...
                      datasets: [
                        {
                          ...
                          borderColor: 'transparent',
                          borderWidth: 1,
                          data: Array.from({ length: 15 }, (_, i) => pseudo(i + 30, 40, 100)),
                        },
                      ],
                    }}
                    options={{
                      ...
                      datasets: [
                        {
                          ...
                          borderWidth: 2,
                          data: Array.from({ length: 15 }, (_, i) => pseudo(i + 45, 40, 100)),
                        },
                      ],
                    }}
                    options={{
                      ...
                      datasets: [
                        {
                          ...
                          borderWidth: 2,
                          data: Array.from({ length: 15 }, (_, i) => pseudo(i + 60, 40, 100)),
                        },
                      ],
                    }}
                    options={{
                      ...
                      datasets: [
                        {
                          ...
                          borderWidth: 2,
                          data: Array.from({ length: 15 }, (_, i) => pseudo(i + 75, 40, 100)),
                        },
                      ],
                    }}
                    options={{
